    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          // Main swiper with proper positioning
          Container(
            margin: const EdgeInsets.only(top: cardTopMargin, bottom: cardBottomMargin),
            child: AppinioSwiper(
              key: ValueKey(_swipedIds.length),
              controller: controller,
              cardBuilder: (BuildContext context, int index) {
...
class _EnhancedCardState extends State<_EnhancedCard>
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(widget.isBackground ? 16 : 24),
        child: Container(
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(widget.isBackground ? 16 : 24),
            boxShadow: widget.isBackground
